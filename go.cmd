...
%CMD_NATIVE% /c cscript pinitem.vbs /item:"C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" /taskbar
%CMD_NATIVE% /c cscript pinitem.vbs /item:"C:\Program Files (x86)\Mozilla Firefox\firefox.exe" /taskbar
%CMD_NATIVE% /c cscript pinitem.vbs /item:"C:\Program Files\ConEmu\ConEmu64.exe" /taskbar
%CMD_NATIVE% /c cscript pinitem.vbs /item:"C:\Program Files (x86)\Mozilla Thunderbird\thunderbird.exe" /taskbar
